...
como tipo vazio, porém, falar que é um tipo sem tipo é o mais apropriado.
...
- Podemos utilizar None quando queremos criar uma variável e inicializá-lo  com um tipo sem tipo, antes de
